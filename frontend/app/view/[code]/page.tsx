      ...
      <div className="min-h-screen p-6 md:p-8 bg-gradient-to-br from-background via-background to-muted/20">
                      ...
                      {itemHasVariants(item) ? (
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            className="flex-1 text-xs md:text-sm px-3 md:px-4 py-3 md:py-2 min-h-[44px] md:min-h-0"
                            size="sm"
                          >
                          ...
                          <Button
                            ...
                            variant="default"
                            className="md:flex-1 text-xs md:text-sm px-3 md:px-4 py-3 md:py-2 min-h-[44px] md:min-h-0"
                            size="sm"
                          >
        ...
        <Sheet open={variantSheetOpen} onOpenChange={setVariantSheetOpen}>
          <SheetContent side="bottom" className="rounded-t-xl max-h-[80vh] flex flex-col">
            ...
            <SheetFooter className="pt-4   border-t gap-2 px-6 -mx-6">
              <Button
                onClick={handleCopyWithVariants}
                variant="outline"
                className="flex-1 py-3 md:py-2"
                size="lg"
              >
